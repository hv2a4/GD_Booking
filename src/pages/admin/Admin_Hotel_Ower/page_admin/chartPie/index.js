...
const RoomPowerComponent = () => {
    ...
    const data1 = [
        { name: 'Tổng phòng', value: roomOccupancy.totalRooms || 0 },
        { name: 'Có khách', value: roomOccupancy.occupiedRooms || 0 },
    ];

    // Dữ liệu cho biểu đồ phòng trống
    const data2 = [
        { name: 'Đang dùng', value: roomUsage.occupiedRooms || 0 },
        { name: 'Phòng trống', value: roomUsage.totalRooms - (roomUsage.occupiedRooms || 0) },
    ];
    ...
    console.log(usagePercentage+ " xin chòa");
                ...
                <div className="card-body">
                    ...
                    <div className="row mt-4 align-items-center">
                        <div className="col-md-6 d-flex flex-column align-items-center mb-3">
                            ...
                            <p style={{ fontSize: '14px', margin: '2px 0' }}>Tỉ lệ: {occupancyRate}%</p>
                        </div>
                        <div className="col-md-6 d-flex flex-column align-items-center mb-3">
                            <DonutChart data={data2} colors={COLORS2} />
                            <p style={{ fontSize: '14px', margin: '2px 2px' }}>{`${roomUsage.occupiedRooms} / ${roomUsage.totalRooms}`}</p>
